      ...
      <body className={`${instrumentSans.className} ${instrumentSans.className}`}>
        ...
        <Toaster
          ...
          toastOptions={{
            ...
            classNames: {
              error:
                "bg-primary sm:min-w-[397px] flex items-center gap-1 text-red-400 text-sm font-semibold rounded-lg px-6 py-4 sm:-ml-5",
              success:
                "bg-primary sm:min-w-[397px] flex items-center justify-center gap-2 text-[#FAFAFA] font-semibold rounded-lg px-6 py-4 sm:-ml-5",
